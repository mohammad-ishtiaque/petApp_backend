...
const { getOwnerDetails, updateOwnerProfile, setRevenueCatIdentity, deleteOwner, getOwnerBusinesses, getAllBookingsByOwner,getBookingsByOwnerWithStatusAndPagination, updateBookingStatus, getBookingsByServiceType, getBookedPetsByOwner, gtPetDetailsByPetId, getOwnerReviewsWithAvg } = require('./owner.controller');
...
router.post('/revenuecat-identify', authenticateOwner, setRevenueCatIdentity);
