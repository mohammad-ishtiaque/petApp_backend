...
const { getOwnerDetails, updateOwnerDetails, deleteOwner, getOwnerBusinesses, getAllBookings } = require('./owner.controller');
...
router.get('/get-bookings', authenticateOwner, getAllBookings);
