...
router.post('/createService',authenticateOwner,  uploadArrayMiddleware('servicesImages', 2) ,createService);
router.get('/getServices', authenticateOwner, getAllServices);
router.get('/getServicesById/:id', authenticateOwner, getServicesById);
router.put('/updateService/:id', authenticateOwner, uploadArrayMiddleware('servicesImages', 2), updateService);
